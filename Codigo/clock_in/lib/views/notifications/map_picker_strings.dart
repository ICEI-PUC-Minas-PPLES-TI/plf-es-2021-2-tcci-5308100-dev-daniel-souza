class MapPickerStrings {
  ...
  factory MapPickerStrings.portuguese(
      {selectAddress = "Selecione endereço",
      saveArea = "Salvar área",
      cancel = "Cancelar",
      delete = "Deletar",
      distanceInKmFromYou = 'À menos de \$ km de você',
      drawAreaOnMap = "Desenhe uma área no mapa ",
      customArea = "Área customizada",
      address = "Endereço",
      firstMessageSelectAddress =
          "Arraste o mapa para selecionar uma localização ou toque para pesquisar"}) {
    return MapPickerStrings(
      selectAddress: selectAddress,
      saveArea: saveArea,
      cancel: cancel,
